namespace ContosoUniversity.Migrations
{
    ...
    public partial class ComplexDataModel : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.CourseInstructorID", "InstructorID", "dbo.Instructor");
            DropForeignKey("dbo.CourseInstructorID", "CourseID", "dbo.Course");
            DropForeignKey("dbo.Course", "DepartmentID", "dbo.Department");
            DropForeignKey("dbo.Department", "InstructorID", "dbo.Instructor");
            DropForeignKey("dbo.OfficeAssignment", "InstructorID", "dbo.Instructor");
            DropIndex("dbo.CourseInstructorID", new[] { "InstructorID" });
            DropIndex("dbo.CourseInstructorID", new[] { "CourseID" });
            ...
            DropTable("dbo.CourseInstructorID");
