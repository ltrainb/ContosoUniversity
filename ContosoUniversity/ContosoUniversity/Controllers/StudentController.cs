    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstName,EnrollmentDate")] Student student)
        {
            ...
            catch (DataException /* dex */)
            {
                ...
                ModelState.AddModelError("", "unable to save changes. try again, and if problem persist, contack your adminstrator.");
            }
            return View(student);
        }
        ...
        public ActionResult Delete(int? id, bool? saveChangesError=false)
        {
            ...
            {
                ViewBag.ErrorMessage = "Delete failed. try again and if problem persist, contact the administrator.";
            }
            Student student = db.Students.Find(id);
            if (student == null)
            {
